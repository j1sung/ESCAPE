...
{
	EnemyDestroyEffect::EffectFrame("  @  ", 0.08f, Color::Red | Color::BgWhite),
	EnemyDestroyEffect::EffectFrame(" @@@  ", 0.08f, Color::Blue | Color::BgWhite),
	EnemyDestroyEffect::EffectFrame(" @@ ", 0.08f, Color::Green | Color::BgWhite),
	EnemyDestroyEffect::EffectFrame("  +1 ", 0.5f, Color::Blue|Color::Red|Color::BgWhite)
};
